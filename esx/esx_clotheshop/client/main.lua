				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('esx_eden_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														exports['mythic_notify']:SendAlert('inform', 'Kıyafetin başarıyla kaydedildi', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
							...
							exports['mythic_notify']:SendAlert('inform', 'Yeterli paran yok', 2500, { ['background-color'] = '#e03232', ['color'] = '#ffffff' })
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerOutfit', function(clothes)
				  ...
				  exports['mythic_notify']:SendAlert('inform', 'Kıyafetini giydin', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
				  HasLoadCloth = true
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerDressing', function(dressing)
			...
			menu.close()
				...
				exports['mythic_notify']:SendAlert('inform', 'Kıyafetin silindi', 2500, { ['background-color'] = '#3d6892', ['color'] = '#ffffff' })
