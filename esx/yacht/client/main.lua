    ...
    Citizen.Wait(1)
      local ped = PlayerPedId()
        ...
        if GetDistanceBetweenCoords(GetEntityCoords(ped), -2084.88, -1018.12, 12.78, true) < 50 then
            DrawMarker(35, -2084.95, -1018.08, 12.78, 0, 0, 0, 0, 0, 75.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 1, 0, 2, 0, 0, 0, 0)
    ...
    while true do 
      Citizen.Wait(1)
        ...
        if location1 == false and tags == true then
            DrawMarker(20, -2054.18, -1032.38, 8.97, 0, 0, 0, 0, 0, 155.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
            if GetDistanceBetweenCoords(GetEntityCoords(ped), -2054.18, -1032.38, 8.97, true) < 1 then
                ...
                -- exports['dd_core']:notify('error', 'Press E to search')
                    if IsControlJustReleased(1, 51) then
                        Animacja()
                        location1 = true
                        searched = searched+1
        ...
        if location2 == false and tags == true then
            DrawMarker(20, -2051.59, -1024.84, 8.97, 0, 0, 0, 0, 0, 155.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location3 == false and tags == true then
            DrawMarker(20, -2076.74, -1018.55, 8.97, 0, 0, 0, 0, 0, 155.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location4 == false and tags == true then
            DrawMarker(20, -2078.1, -1022.55, 8.97, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location5 == false and tags == true then
            DrawMarker(20, -2087.27, -1019.9, 8.97, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location6 == false and tags == true then
            DrawMarker(20, -2085.70, -1015.18, 8.97, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location7 == false and tags == true then
            DrawMarker(20, -2096.22, -1014.49, 8.97, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location8 == false and tags == true then
            DrawMarker(20, -2094.77, -1020.14, 8.97, 0, 0, 0, 0, 0, 155.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location9 == false and tags == true then
            DrawMarker(20, -2090.70, -1010.64, 8.97, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location10 == false and tags == true then
            DrawMarker(20, -2096.18, -1016.3, 5.88, 0, 0, 0, 0, 0, 155.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location11 == false and tags == true then
            DrawMarker(20, -2096.1, -1008.06, 5.88, 0, 0, 0, 0, 0, 170.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location12 == false and tags == true then
            DrawMarker(20, -2090.33, -1013.92, 5.88, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location13 == false and tags == true then
            DrawMarker(20, -2089.00, -1009.75, 5.88, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location14 == false and tags == true then
            DrawMarker(20, -2084.56, -1014.13, 5.88, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location15 == false and tags == true then
            DrawMarker(20, -2082.85, -1012.15, 5.88, 0, 0, 0, 0, 0, 170.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location16 == false and tags == true then
            DrawMarker(20, -2077.13, -1022.54, 5.88, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location17 == false and tags == true then
            DrawMarker(20, -2071.12, -1020.73, 5.88, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location18 == false and tags == true then
            DrawMarker(20, -2083.51, -1018.52, 12.78, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location19 == false and tags == true then
            DrawMarker(20, -2073.03, -1018.47, 11.78, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
        ...
        if location20 == false and tags == true then
            DrawMarker(20, -2075.15, -1024.79, 11.78, 0, 0, 0, 0, 0, 70.0, 0.5, 0.5, 0.5, 255, 0, 0, 155, 0, 0, 2, 0, 0, 0, 0)
...
function Animacja()
  ...
  Citizen.CreateThread(function()
    ...
    if searched ~= 20 then
        exports['okokNotify']:Alert("", "Nothing found here!", 3000, 'error')
      end
  end)
...
RegisterNetEvent('esx_yacht:killblip')
AddEventHandler('esx_yacht:killblip', function()
    RemoveBlip(blipRobbery)
end)
RegisterNetEvent('esx_yacht:setblip')
AddEventHandler('esx_yacht:setblip', function()
    blipRobbery = AddBlipForCoord(-2084.88, -1018.12, 12.78)
