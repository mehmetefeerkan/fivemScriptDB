...
local HasAlreadyEnteredMarker, isHandcuffed, hasAlreadyJoined, playerInService = false, false, false, false
...
AddEventHandler('pdgarage:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('pdgarage:hasExitedMarker', function(station, part, partNum)
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('pdgarage:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('pdgarage:hasEnteredMarker', currentStation, currentPart, currentPartNum)
			end
