...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -339.788, y = -137.956, z = 39.009},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
	...
	ls2 = {
		Pos   = { x = 540.6519, y = -176.564, z = 54.481},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 731.4227, y = -1088.68, z = 21.744},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = -212.04, y = -1325.02, z = 30.47},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = -2186.03, y = 3167.42, z = 32.81},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x = 938.4426, y = -970.728, z = 39.119},
		Size  = {x = 0, y = 0, z = 0},
		Color = {r = 25, g = 156, b = 213},
		Type = 1,
		Name  = _U('blip_name'),
