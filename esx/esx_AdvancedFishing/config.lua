Config = {}
	...
	Config.FishPrice = {a = 50, b = 75} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 150, b = 175} --Will get dirty money
	Config.SharkPrice = {a = 200, b = 250} --Will get dirty money
