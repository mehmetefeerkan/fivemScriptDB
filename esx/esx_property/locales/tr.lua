Locales['tr'] = {
  ...
  ['property'] = 'Ev',
  ['enter'] = 'Gir',
  ['move_out'] = 'kirayı feshet',
  ['move_out_sold'] = 'mülkü &nbsp;<span style="color:green;">$%s</span>&nbsp; karşılığında sat',
  ['moved_out'] = 'taşındın artık mülkü kiralamıyorsun',
  ['moved_out_sold'] = 'mülkü $%s karşılığında sattın',
  ['leave'] = 'Sat',
  ['buy'] = 'Satın Al',
  ['buy_for'] = '$%s karşılığında bir mülk satın aldınız',
  ['rent'] = 'Kirala',
  ['rent_for'] = '$%s / hafta için bir mülk kiraladınız, ödeme otomatik',
  ['visit'] = 'Ziyaret Et',
