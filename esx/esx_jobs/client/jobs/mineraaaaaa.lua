Config.Jobs.miner = {
	...
	Zones = {
		...
		VehicleDeletePoint = {
			Pos = {x = 876.06, y = -2185.66, z = 30.52},
			Size = {x = 1.0, y = 1.0, z = 1.0},
			Color = {r = 255, g = 0, b = 0},
			Marker = 21,
			Blip = false,
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 32, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 30,
					requires = "iron",
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 18, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 70,
					requires = "gold",
