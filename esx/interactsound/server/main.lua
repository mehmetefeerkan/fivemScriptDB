...
RegisterServerEvent('brn:PlayWithinDistance')
AddEventHandler('brn:PlayWithinDistance', function(maxDistance, soundFile, soundVolume, triggerCoords)
    TriggerClientEvent('brn_cl:PlayWithinDistance', -1, triggerCoords, maxDistance, soundFile, soundVolume)
end)