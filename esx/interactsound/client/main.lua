...
AddEventHandler('InteractSound_CL:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
    ...
    local distIs  = Vdist2(lCoords.x, lCoords.y, lCoords.z, eCoords.x, eCoords.y, eCoords.z)
...
RegisterNetEvent('brn_cl:PlayWithinDistance')
AddEventHandler('brn_cl:PlayWithinDistance', function(eCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
