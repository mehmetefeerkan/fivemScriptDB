RegisterNetEvent('chubbsnotify:client:SendAlert')
AddEventHandler('chubbsnotify:client:SendAlert', function(data)
	DoCustomHudText(data.type, data.text, data.length, data.style)
end)

RegisterNetEvent('chubbsnotify:client:PersistentHudText')
AddEventHandler('chubbsnotify:client:PersistentHudText', function(data)
