		...
		elseif GetVehicleDoorAngleRatio(vehicle, 5) ~= 0.0 then
			...
			while inside do
            	...
            	if DropPosition["x"] == 0.0 then
                	...
                	DrawText3DTest(vehCoords.x, vehCoords.y, vehCoords.z, "[Z] Ac/Kapat | [F] Bagajdan Cik")

            	else

                	DrawText3DTest(DropPosition["x"],DropPosition["y"],DropPosition["z"],"[Z] Ac/Kapat | [F] Bagajdan Cik")
				...
				if IsDisabledControlJustReleased(0,48) then
