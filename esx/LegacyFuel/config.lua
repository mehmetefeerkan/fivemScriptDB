...
Config.Strings = {
	ExitVehicle = "Benzin doldurmak için araçtan inin",
	EToRefuel = " ~g~[E]~w~ Benzin Doldur",
	JerryCanEmpty = "Benzin Bidonu Boş",
	FullTank = "Depo Dolu",
	--PurchaseJerryCan = "[E] Benzin Bidonu Al" .. Config.JerryCanCost,
	CancelFuelingPump = " ~g~[E]~w~ Benzin doldurmayı durdur",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "~g~E ~w~to grab a jerry can"
	Config.Strings.RefillJerryCan = "~g~E ~w~ to refill the jerry can"
end
