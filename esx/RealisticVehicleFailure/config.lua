...
repairCfg = {
	...
	fixMessages = {
		"Yağ tapasını tekrar yerine taktınız",
		"Sakız kullanarak yağ sızıntısını durdurdunuz",
		"Yağ borusunu gaffer bandı ile tamir ettiniz",
		"Yağ karteri vidasını sıktınız ve damlamayı durdurdunuz",
		"Motoru tekmeledi ve sihirli bir şekilde hayata geri döndü",
		"Kıvılcım borusundan biraz pas çıkardın",
		"Aracına bağırdın ve bir şekilde etkisi oldu"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Yağ tapasını kontrol ettin. Hala orada",
		"Motoruna baktın, iyi görünüyordu",
		"Kirpi bandının hala motoru bir arada tuttuğundan emin oldun",
		"Sen radyo sesini açtın. Sadece garip motor seslerini boğdu",
		"Kıvılcım borusuna pas önleyici eklediniz. Fark etmedi",
		"Asla kırılmayan bir şeyi düzeltmeyin dediler. Dinlemediniz. En azından daha kötüye gitmedi"
	},
	noFixMessageCount = 6
}
