...
var toIdentifier = __webpack_require__(119)
...
var db = __webpack_require__(105)
...
var unpipe = __webpack_require__(174)
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(115)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(116)
})
...
const Promise = __webpack_require__(140)
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(145);
...
var raw = __webpack_require__(22);
...
const flatMap = __webpack_require__(73);
...
const isGeneratorFunction = __webpack_require__(93);
const debug = __webpack_require__(94)('koa:application');
const onFinished = __webpack_require__(43);
const response = __webpack_require__(100);
const compose = __webpack_require__(113);
const isJSON = __webpack_require__(44);
const context = __webpack_require__(114);
...
const http = __webpack_require__(10);
const only = __webpack_require__(19);
...
const buddy = __webpack_require__(153);
const forms = __webpack_require__(179);
const symbolUnparsed = __webpack_require__(186);
...
var fs = __webpack_require__(2);
var ncp = __webpack_require__(187).ncp;
var path = __webpack_require__(0);
var rimraf = __webpack_require__(188);
...
/* harmony import */ var _citizenfx_http_wrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66);
...
/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67);
...
/* harmony import */ var koa__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(68);
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69);
...
/* harmony import */ var koa_body__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(70);
...
/* harmony import */ var mv__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(71);
...
var ES2016 = __webpack_require__(77);
...
var ES2015 = __webpack_require__(78);
var assign = __webpack_require__(16);
...
var hasRegExpMatcher = __webpack_require__(88);
...
var hasSymbolSham = __webpack_require__(84);
...
const contentDisposition = __webpack_require__(101);
const ensureErrorHandler = __webpack_require__(103);
const getType = __webpack_require__(104);
const onFinish = __webpack_require__(43);
const isJSON = __webpack_require__(44);
const escape = __webpack_require__(108);
const typeis = __webpack_require__(18).is;
const statuses = __webpack_require__(12);
const destroy = __webpack_require__(111);
const assert = __webpack_require__(13);
const extname = __webpack_require__(0).extname;
const vary = __webpack_require__(112);
const only = __webpack_require__(19);
const util = __webpack_require__(1);
...
const LRU = __webpack_require__(107);
...
const httpAssert = __webpack_require__(120);
const delegate = __webpack_require__(124);
const statuses = __webpack_require__(12);
const Cookies = __webpack_require__(125);
...
var createError = __webpack_require__(14)
var eql = __webpack_require__(121)
...
var Keygrip = __webpack_require__(126)
...
const URL = __webpack_require__(21).URL;
const net = __webpack_require__(128);
const accepts = __webpack_require__(129);
const contentType = __webpack_require__(135);
const stringify = __webpack_require__(21).format;
const parse = __webpack_require__(136);
const qs = __webpack_require__(47);
const typeis = __webpack_require__(18);
const fresh = __webpack_require__(137);
const only = __webpack_require__(19);
const util = __webpack_require__(1);
...
module.exports = __webpack_require__(141)().Promise
...
module.exports = __webpack_require__(142)(global, loadImplementation);
...
function loadImplementation(implementation){
  ...
  if(shouldPreferGlobalPromise(implementation)){
    ...
    var lib = __webpack_require__(143)(implementation)
    impl = {
...
var debug = __webpack_require__(49)('koa-router');
var pathToRegExp = __webpack_require__(149);
...
(function (root, factory) {
  ...
  if ( true && module.exports) {
    // Node
    module.exports = factory(__webpack_require__(51), __webpack_require__(52), __webpack_require__(53));
  } else if (true) {
    // AMD. Register as an anonymous module.
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(51), __webpack_require__(52), __webpack_require__(53)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
exports.json = __webpack_require__(54);
exports.form = __webpack_require__(58);
exports.text = __webpack_require__(61);
...
var text = __webpack_require__(61);
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(158); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(172)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(173)(iconv);
}
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(167) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(168) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(23).concat(__webpack_require__(56)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(23).concat(__webpack_require__(56)) },
        gb18030: function() { return __webpack_require__(169) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(57).concat(__webpack_require__(171)) },
...
var IncomingForm = __webpack_require__(180).IncomingForm;
...
var util = __webpack_require__(1),
    path = __webpack_require__(0),
    File = __webpack_require__(181),
    MultipartParser = __webpack_require__(182).MultipartParser,
    QuerystringParser = __webpack_require__(183).QuerystringParser,
    OctetParser       = __webpack_require__(184).OctetParser,
    JSONParser = __webpack_require__(185).JSONParser,
