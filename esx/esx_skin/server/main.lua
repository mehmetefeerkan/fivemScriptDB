...
AddEventHandler('esx_skin:save', function(skin)
	...
	print("^1Trigger:^1^2esx_skin:responseSaveSkin^2 | Karakter Save.^2 ^5" .. GetPlayerName(source) .. "^6 [" .. source .. "] ^3Tarafindan tetiklendi.^3")
...
ESX.RegisterServerCallback('esx_skin:getPlayerSkin', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	print("^1Trigger:^1^2esx_skin:responseSaveSkin^2 | Karakter Bölümü.^2 ^5" .. GetPlayerName(source) .. "^6 [" .. source .. "] ^3Tarafindan tetiklendi.^3")
