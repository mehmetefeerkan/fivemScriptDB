...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if sourceXPlayer.job.name ~= 'police' then
		print(('esx_policejob: %s tarafindan el konuldu!'):format(xPlayer.identifier))
		return
	end
...
AddEventHandler('esx_policejob:revive', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		print(('esx_policejob: %s canlandirildi!'):format(xPlayer.identifier))
	end
end)--]]
...
RegisterServerEvent('esx_policejob:heal')
AddEventHandler('esx_policejob:heal', function(target, type)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'police' then
		TriggerClientEvent('esx_policejob:heal', target, type)
	else
		print(('esx_policejob: %s iyilestirildi!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_policejob:handcuff', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		print(('esx_policejob: %s tarafindan kelepcelendin!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_policejob:drag', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		print(('esx_policejob: %s tarafindan surukleniyorsun!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_policejob:putInVehicle', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		print(('esx_policejob: %s tarafindan araca sokuldun!'):format(xPlayer.identifier))
	end
end)
...
AddEventHandler('esx_policejob:OutVehicle', function(target)
	...
	if xPlayer.job.name == 'police' then
		...
		print(('esx_policejob: %s tarafindan aractan cikartildin!'):format(xPlayer.identifier))
	end
end)
...
ESX.RegisterServerCallback('esx_policejob:buyWeapon', function(source, cb, weaponName, type, componentNum)
	...
	if not selectedWeapon then
		print(('esx_policejob: %s gecersiz bir silah almaya calistin.'):format(xPlayer.identifier))
		cb(false)
	end
	...
	elseif type == 2 then
		...
		if component then
			...
			print(('esx_policejob: %s gecersiz bir gelistirme yapmaya calisiyorsun!'):format(xPlayer.identifier))
			cb(false)
		end
	end
end)
...
ESX.RegisterServerCallback('esx_policejob:buyJobVehicle', function(source, cb, vehicleProps, type)
	...
	if price == 0 then
		print(('esx_policejob: %s gecersiz arac! (gecersiz model)'):format(xPlayer.identifier))
		cb(false)
	end
	...
	if not foundPlate then
		...
		MySQL.Async.execute('UPDATE owned_vehicles SET `stored` = true WHERE owner = @owner AND plate = @plate AND job = @job', {
			...
			if rowsChanged == 0 then
				print(('esx_policejob: %s polis garajini kullandin.'):format(xPlayer.identifier))
				cb(false)
			else
				cb(true, foundNum)
			end
...
RegisterServerEvent('brn:yaralibindir')
AddEventHandler('brn:yaralibindir', function(target)
    TriggerClientEvent('brn:ybindir', target)
end)

RegisterServerEvent('brn:yaralindir')
AddEventHandler('brn:yaralindir', function(target)
    local xPlayer = ESX.GetPlayerFromId(source)
        TriggerClientEvent('brn:yaralıindir', target)
end)
