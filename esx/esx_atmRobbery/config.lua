...
Config.RequiredPolice = 5		-- Required Police online to rob an ATM.

Config.DispatchMessage = "^3 10-90 ^0 atm soygunu ^5%s^0"

-- Reward Settings:
Config.EnableDirtyCash = false			-- Set between true(receive dirty cash) or false(receive normal cash)		
Config.MinReward = 5000					-- Set minimum payout
Config.MaxReward = 35000				-- Set maximum payout
