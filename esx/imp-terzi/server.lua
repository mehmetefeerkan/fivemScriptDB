...
AddEventHandler('kvl-terzi:yunprocess', function()
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    if xPlayer.getInventoryItem('yun').count >= 2 then
...
AddEventHandler('kvl-terzi:kumasuret', function()
    ...
    if xPlayer.getInventoryItem('islenmis_yun').count >= 1 then
...
AddEventHandler('kvl-terzi:gomlekdik', function()
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    if xPlayer.getInventoryItem('gomlek_kumasi').count >= 1 then
...
AddEventHandler('kvl-terzi:pantolondik', function()
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    if xPlayer.getInventoryItem('pantolon_kumasi').count >= 1 then
...
AddEventHandler('kvl-terzi:tshirtdik', function()
    local src = source
    local xPlayer = ESX.GetPlayerFromId(src)
    if xPlayer.getInventoryItem('tshirt_kumasi').count >= 1 then
