...
local function DrawButton(b)
	...
	DrawSprite("dp_clothing", b.Sprite, b.x, b.y, b.Size.Sprite.x/0.68, b.Size.Sprite.y/0.68, b.Rotation, 192,192,192, b.Alpha)
...
local function HoveredButton()
	...
	for k,v in pairs(Buttons) do
		...
		if Distance < 0.025 then
			...
			Text(Config.GUI.Position.x, Config.GUI.Position.y-0.08, 0.22, v.Desc, {255,0,0}, false, true, {x = 0.1, y = 0.2})
		end
	end
...
local function DrawGUI()
	...
	for k,v in pairs(Buttons) do
		...
		if LastEquipped[FirstUpper(v.Sprite)] then
			Alpha = 180 Colour = {r=245,g=245,b=245,a=220}
		else 
			Alpha = 255 Colour = {r=245,g=245,b=245,a=255}
		end
