...
local blips = {}
local buyablehouses = {
    [1] = {x = 1061.04, y = -378.61, z = 68.24, houseid = 1, price = 5000000, info = 'Stashouse 1'},
    [2] = {x = 1029.42, y = -408.96, z = 65.95, houseid = 2, price = 5000000, info = 'Stashouse 2'},
    [3] = {x = 1011.27, y = -422.89, z = 64.96, houseid = 3, price = 5000000, info = 'Stashouse 3'},
    [4] = {x = 988.2, y = -433.74, z = 63.9, houseid = 4, price = 5000000, info = 'Stashouse 4'},
    [5] = {x = 967.9, y = -452.62, z = 62.41, houseid = 5, price = 5000000, info = 'Stashouse 5'},
    [6] = {x = 943.26, y = -463.9, z = 61.4, houseid = 6, price = 5000000, info = 'Stashouse 6'},
    [7] = {x = 922.18, y = -478.69, z = 61.09, houseid = 7, price = 5000000, info = 'Stashouse 7'},
    [8] = {x = 906.58, y = -489.69, z = 59.44, houseid = 8, price = 5000000, info = 'Stashouse 8'},
    [9] = {x = 878.99, y = -498.51, z = 57.88, houseid = 9, price = 5000000, info = 'Stashouse 9'},
    [10] = {x = 862.28, y = -509.58, z = 57.33, houseid = 10, price = 5000000,  info = 'Stashouse 10'},
    [11] = {x = 851.09, y = -532.73, z = 57.93, houseid = 11, price = 5000000, info = 'Stashouse 11'},
    [12] = {x = 844.37, y = -563.77, z = 57.84, houseid = 12, price = 5000000, info = 'Stashouse 12'},
    [13] = {x = 861.92, y = -582.26, z = 58.16, houseid = 13, price = 5000000, info = 'Stashouse 13'},
    [14] = {x = 887.43, y = -607.54, z = 58.22, houseid = 14, price = 5000000, info = 'Stashouse 14'},
    [15] = {x = 903.47, y = -615.87, z = 58.46, houseid = 15, price = 5000000, info = 'Stashouse 15'},
    [16] = {x = 929.51, y = -639.12, z = 58.25, houseid = 16, price = 5000000, info = 'Stashouse 16'},
    [17] = {x = 943.4, y = -653.71, z = 58.43, houseid = 17, price = 5000000,  info = 'Stashouse 17'},
    [18] = {x = 960.54, y = -669.38, z = 58.45, houseid = 18, price = 5000000, info = 'Stashouse 18'},
    [19] = {x = 970.9, y = -701.41, z = 58.49, houseid = 19, price = 5000000, info = 'Stashouse 19'},
    [20] = {x = 979.49, y = -715.95, z = 58.22, houseid = 20, price = 5000000, info = 'Stashouse 20'},
    [21] = {x = 997.52, y = -729.0, z = 57.82, houseid = 21, price = 5000000, info = 'Stashouse 21'},
    [22] = {x = 979.92, y = -627.24, z = 59.24, houseid = 22, price = 5000000, info = 'Stashouse 22'},
    [23] = {x = 892.79, y = -540.7, z = 58.51, houseid = 23, price = 5000000, info = 'Stashouse 23'},
    [24] = {x = 924.02, y = -525.3, z = 59.58, houseid = 24, price = 5000000, info = 'Stashouse 24'},
    [25] = {x = 946.26, y = -518.79, z = 60.63, houseid = 25, price = 5000000, info = 'Stashouse 25'},
    [26] = {x = 969.57, y = -502.1, z = 62.15,  houseid = 26, price = 5000000, info = 'Stashouse 26'},
    [27] = {x = 1014.14, y = -468.72, z = 64.29, houseid = 27, price = 5000000, info = 'Stashouse 27'},
    [28] = {x = 1112.37, y = -390.29, z = 68.74, houseid = 28, price = 5000000, info = 'Stashouse 28'},
    [29] = {x = 1263.96, y = -429.2, z = 69.81, houseid = 29, price = 5000000, info = 'Stashouse 29'},
    [30] = {x = 1266.76, y = -457.85, z = 70.52, houseid = 30, price = 5000000, info = 'Stashouse 30'},
    [31] = {x = 1260.28, y = -479.9, z = 70.19, houseid = 31, price = 5000000, info = 'Stashouse 31'},
    [32] = {x = 1251.86, y = -494.2, z = 69.91, houseid = 32, price = 5000000, info = 'Stashouse 32'},
    [33] = {x = 1251.5, y = -515.63, z = 69.35, houseid = 33, price = 5000000, info = 'Stashouse 33'},
    [34] = {x = 1242.17, y = -565.88, z = 69.66, houseid = 34, price = 5000000, info = 'Stashouse 34'},
    [35] = {x = 1241.1, y = -601.67, z = 69.59, houseid = 35, price = 5000000, info = 'Stashouse 35'},
    [36] = {x = 1251.6, y = -621.98, z = 69.41, houseid = 36, price = 5000000, info = 'Stashouse 36'},
    [37] = {x = 1265.41, y = -647.89, z = 67.93, houseid = 37, price = 5000000, info = 'Stashouse 37'},
    [38] = {x = 1271.13, y = -683.04, z = 66.04, houseid = 38, price = 5000000, info = 'Stashouse 38'},
    [39] = {x = 1265.94, y = -703.52, z = 64.56, houseid = 39, price = 5000000, info = 'Stashouse 39'},
    [40] = {x = 1302.79, y = -528.61, z = 71.47, houseid = 40, price = 5000000, info = 'Stashouse 40'},
    [41] = {x = 1327.76, y = -535.86, z = 72.45, houseid = 41, price = 5000000, info = 'Stashouse 41'},
    [42] = {x = 1347.87, y = -548.01, z = 73.9, houseid = 42, price = 5000000, info = 'Stashouse 42'},
    [43] = {x = 1372.97, y = -555.69, z = 74.69, houseid = 43, price = 5000000, info = 'Stashouse 43'},
    [44] = {x = 1388.3, y = -569.93, z = 74.5, houseid = 44, price = 5000000, info = 'Stashouse 44'},
    [45] = {x = 1385.47, y = -592.93, z = 74.49, houseid = 45, price = 5000000, info = 'Stashouse 45'},
    [46] = {x = 1367.28, y = -605.44, z = 74.72, houseid = 46, price = 5000000, info = 'Stashouse 46'},
    [47] = {x = 1341.63, y = -597.5, z = 74.71, houseid = 47, price = 5000000, info = 'Stashouse 47'},
    [48] = {x = 1323.76, y = -582.45, z = 73.25, houseid = 48, price = 5000000, info = 'Stashouse 48'},
    [49] = {x = 1301.24, y = -573.21, z = 71.74, houseid = 49, price = 5000000, info = 'Stashouse 49'},
    [50] = {x = 1437.15, y = -1492.97, z = 63.44, houseid = 50, price = 5000000, info = 'Stashouse 50'},
    [51] = {x = 118.41, y = -1921.02, z = 21.32, houseid = 51, price = 5000000, info = 'Stashouse 51'},
    [52] = {x = 101.1, y = -1912.31, z = 21.41, houseid = 52, price = 5000000, info = 'Stashouse 52'},
    [53] = {x = 86.0, y = -1959.54, z = 21.12, houseid = 53, price = 5000000, info = 'Stashouse 53'},
    [54] = {x = 114.39, y = -1961.16, z = 21.33, houseid = 54, price = 5000000, info = 'Stashouse 54'},
    [55] = {x = 76.18, y = -1948.19, z = 21.17, houseid = 55, price = 5000000, info = 'Stashouse 55'},
    [56] = {x = -140.3, y = -1599.58, z = 34.83, houseid = 56, price = 5000000, info = 'Stashouse 56'},
    [57] = {x = -147.81, y = -1596.49, z = 34.83, houseid = 57, price = 5000000, info = 'Stashouse 57'},
    [58] = {x = -119.96, y = -1574.65, z = 34.18, houseid = 58, price = 5000000, info = 'Stashouse 58'},
    [59] = {x = -134.25, y = -1580.34, z = 37.41, houseid = 59, price = 5000000, info = 'Stashouse 59'},
    [60] = {x = -140.06, y = -1587.3, z = 37.41, houseid = 60, price = 5000000, info = 'Stashouse 60'},
    [61] = {x = -140.41, y = -1599.49, z = 38.21, houseid = 61, price = 5000000, info = 'Stashouse 61'},
    [62] = {x = 343.47, y = -2027.81, z = 22.35, houseid = 62, price = 5000000, info = 'Stashouse 62'},
    [63] = {x = 352.02, y = -2034.98, z = 22.35, houseid = 63, price = 5000000, info = 'Stashouse 63'},
    [64] = {x = 365.23, y = -2064.6, z = 21.74, houseid = 64, price = 5000000, info = 'Stashouse 64'},
    [65] = {x = 341.82, y = -2064.52, z = 20.94, houseid = 65, price = 5000000, info = 'Stashouse 65'},
    [66] = {x = 399.13, y = -1864.9, z = 26.72, houseid = 66, price = 5000000, info = 'Stashouse 66'},
    [67] = {x = 412.47, y = -1856.38, z = 27.32, houseid = 67, price = 5000000, info = 'Stashouse 67'},
    [68] = {x = 427.25, y = -1842.08, z = 28.46, houseid = 68, price = 5000000, info = 'Stashouse 68'},
    [69] = {x = 440.44, y = -1829.66, z = 28.36, houseid = 69, price = 5000000, info = 'Stashouse 69'},
    [70] = {x = -1109.16, y = -1482.35, z = 4.93, houseid = 70, price = 5000000, info = 'Stashouse 70'},
    [71] = {x = -1142.53, y = -1461.34, z = 4.63, houseid = 71, price = 5000000, info = 'Stashouse 71'},
    [72] = {x = -1883.28, y = -578.94, z = 11.82, houseid = 72, price = 5000000, info = 'Stashouse 72'},
    [73] = {x = -1901.72, y = -586.55, z = 11.88, houseid = 73, price = 5000000, info = 'Stashouse 73'},
    [74] = {x = -1913.45, y = -574.22, z = 11.44, houseid = 74, price = 5000000, info = 'Stashouse 74'},
    [75] = {x = -1917.79, y = -558.82, z = 11.85, houseid = 75, price = 5000000, info = 'Stashouse 75'},
    [76] = {x = -1924.05, y = -559.33, z = 12.07, houseid = 76, price = 5000000, info = 'Stashouse 76'},
    [77] = {x = -1918.64, y = -542.55, z = 11.83, houseid = 77, price = 5000000, info = 'Stashouse 77'},
    [78] = {x = -1947.03, y = -544.07, z = 11.87, houseid = 78, price = 5000000, info = 'Stashouse 78'},
    [79] = {x = -1947.95, y = -531.65, z = 11.83, houseid = 79, price = 5000000, info = 'Stashouse 79'},
    [80] = {x = -1968.27, y = -532.39, z = 12.18, houseid = 80, price = 5000000, info = 'Stashouse 80'},
    [81] = {x = -1968.36, y = -523.33, z = 11.85, houseid = 81, price = 5000000, info = 'Stashouse 81'},
    [82] = {x = -1980.0, y = -520.54, z = 11.9, houseid = 82, price = 5000000, info = 'Stashouse 82'},
    [83] = {x = -1070.57, y = -1653.81, z = 4.41, houseid = 83, price = 5000000, info = 'Stashouse 83'},
    [84] = {x = -1076.09, y = -1645.79, z = 4.51, houseid = 84, price = 5000000, info = 'Stashouse 84'},
    [85] = {x = -1082.93, y = -1631.47, z = 4.74, houseid = 85, price = 5000000, info = 'Stashouse 85'},
    [86] = {x = -1088.77, y = -1623.08, z = 4.74, houseid = 86,  price = 5000000, info = 'Stashouse 86'},
    [87] = {x = -1092.39, y = -1607.42, z = 8.47, houseid = 87, price = 5000000, info = 'Stashouse 87'},
    [88] = {x = -1106.29, y = -1596.34, z = 4.6, houseid = 88, price = 5000000, info = 'Stashouse 88'},
    [89] = {x = -1038.86, y = -1609.53, z = 5.0, houseid = 89, price = 5000000, info = 'Stashouse 89'},
    [90] = {x = -1029.29, y = -1603.62, z = 4.97, houseid = 90, price = 5000000, info = 'Stashouse 90'},
    [91] = {x = -1032.69, y = -1582.77, z = 5.14, houseid = 91, price = 5000000, info = 'Stashouse 91'},
    [92] = {x = -1043.47, y = -1580.43, z = 5.04, houseid = 92, price = 5000000, info = 'Stashouse 92'},
    [93] = {x = -1041.27, y = -1591.25, z = 4.99, houseid = 93, price = 5000000, info = 'Stashouse 93'},
    [94] = {x = -1057.06, y = -1587.44, z = 4.61, houseid = 94, price = 5000000, info = 'Stashouse 94'},
    [95] = {x = -1058.16, y = -1540.21, z = 5.05, houseid = 95, price = 5000000, info = 'Stashouse 95'},
    [96] = {x = 35.27, y = 6662.8, z = 32.2, houseid = 96, price = 5000000, info = 'Stashouse 96'},
    [97] = {x = -9.75, y = 6654.15, z = 31.7, houseid = 97, price = 5000000, info = 'Stashouse 97'},
    [98] = {x = -41.3, y = 6636.99, z = 31.09, houseid = 98,  price = 5000000, info = 'Stashouse 98'},
    [99] = {x = -130.1, y = 6551.49, z = 29.53, houseid = 99, price = 5000000, info = 'Stashouse 99'},
    [100] = {x = -229.77, y = 6445.18, z = 31.2, houseid = 100, price = 5000000, info = 'Stashouse 100'},
    [101] = {x = -238.37, y = 6423.4, z = 31.46, houseid = 101, price = 5000000, info = 'Stashouse 101'},
    [102] = {x = -272.14, y = 6400.61, z = 31.51, houseid = 102, price = 5000000, info = 'Stashouse 102'},
    [103] = {x = -359.51, y = 6334.64, z = 29.85, houseid = 103, price = 5000000, info = 'Stashouse 103'},
    [104] = {x = -407.22, y = 6314.12, z = 28.95, houseid = 104, price = 5000000, info = 'Stashouse 104'},
    [105] = {x = -447.9, y = 6271.69, z = 33.34, houseid = 105, price = 5000000, info = 'Stashouse 105'},
    [106] = {x = -467.97, y = 6206.18, z = 29.56, houseid = 106, price = 5000000, info = 'Stashouse 106'},
    [107] = {x = -379.73, y = 6253.05, z = 31.86, houseid = 107, price = 5000000, info = 'Stashouse 107'},
    [108] = {x = -370.91, y = 6267.2, z = 31.88, houseid = 108, price = 5000000, info = 'Stashouse 108'},
    [109] = {x = -302.07, y = 6327.4, z = 32.89, houseid = 109, price = 5000000, info = 'Stashouse 109'},
    [110] = {x = -280.62, y = 6350.84, z = 32.61, houseid = 110, price = 5000000, info = 'Stashouse 110'},
    [111] = {x = -247.88, y = 6369.98, z = 31.85, houseid = 111, price = 5000000, info = 'Stashouse 111'},
    [112] = {x = -227.7, y = 6377.93, z = 31.76, houseid = 112, price = 5000000, info = 'Stashouse 112'},
    [113] = {x = -213.86, y = 6396.5, z = 33.09, houseid = 113, price = 5000000, info = 'Stashouse 113'},
    [114] = {x = -189.07, y = 6409.72, z = 32.3, houseid = 114, price = 5000000, info = 'Stashouse 114'},
    [115] = {x = -167.23, y = 6439.25, z = 31.92, houseid = 115, price = 5000000, info = 'Stashouse 115'},
    [116] = {x = -160.3, y = 6432.18, z = 31.92, houseid = 116, price = 5000000, info = 'Stashouse 116'},
    [117] = {x = -150.38, y = 6422.38, z = 31.92, houseid = 117, price = 5000000, info = 'Stashouse 117'},
    [118] = {x = -150.38, y = 6416.99, z = 31.92, houseid = 118, price = 5000000, info = 'Stashouse 118'},
    [119] = {x = -157.31, y = 6409.99, z = 31.92, houseid = 119, price = 5000000, info = 'Stashouse 119'}
}
...
RegisterCommand('evgir',function()
  local playerCoords = GetEntityCoords(PlayerPedId(), true)
    for id,v in pairs(buyablehouses) do
        if GetDistanceBetweenCoords(playerCoords, v.x, v.y, v.z, true) <= 2.5 then
...
function DrawText3Ds(x,y,z, text)
  ...
  function OpenPropertyInventoryMenu()
...
function houseconfigs()
 ...
 elements[4] = {label = "Yeni Ev Sahibi",val="yenievsahibi"}
 elements[5] = {label = "Yedek Anahtar",val="yedekanahtar"}
 elements[6] = {label = "Menüyü Kapat",val="menukapat"}
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
   ...
   elseif data.current.val == "Depolama" then
    ...
    menu.close()
  elseif data.current.val == "menukapat" then
    menu.close()
...
function(data4, menu4)
  local targetplayer = data4.value
  local evid = evinidsi
  TriggerServerEvent("hsn-stashouse:addnewowner",targetplayer,evid)
  menu4.close()
    menu.close()
    end)
  elseif data.current.val == "yedekanahtar" then
...
function(data5, menu5)
  ...
  local evid = evinidsi
  TriggerServerEvent("hsn-stashouse:yedekanahtar",targetplayer,evid)
  menu5.close()
    menu.close()
    end)
