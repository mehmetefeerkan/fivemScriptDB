...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Animasyon oynat', {{ name="animasyonadı", help="dans, notdefteri, otur veya herhangi bir animasyon yazın."}})
    TriggerEvent('chat:addSuggestion', '/e', 'Animasyon oynat', {{ name="animasyonadı", help="dans, notdefteri, otur veya herhangi bir animasyon yazın."}})
    TriggerEvent('chat:addSuggestion', '/emote', 'Animasyon oynat', {{ name="animasyonadı", help="dans, notdefteri, otur veya herhangi bir animasyon yazın."}})
    if Config.SqlKeybinding then
      TriggerEvent('chat:addSuggestion', '/emotebind', 'Kısayol oluştur', {{ name="tuş", help="num4, num5, num6, num7. num8, num9. Numpad 4-9!"}, { name="animasyonadı", help="dans, notdefteri, otur veya herhangi bir animasyon yazın."}})
      TriggerEvent('chat:addSuggestion', '/emotebinds', 'Kısayol animasyonlarını gör.')
    end
    TriggerEvent('chat:addSuggestion', '/emotemenu', 'Menüyü F7 tuşu ile açabilirsiniz.')
    TriggerEvent('chat:addSuggestion', '/emotes', 'Kullanılabilir animasyonları listele.')
    TriggerEvent('chat:addSuggestion', '/walk', 'Yürüyüş tarzınızı ayarlayın.', {{ name="style", help="/walks Yürüş tarzı listeler"}})
    TriggerEvent('chat:addSuggestion', '/walks', 'Mevcut yürüyüş tarzını listele.')
end)
