...
DP.Emotes = {
   ...
   ["so2"] = {"timetable@ron@ig_5_p3", "ig_5_p3_base", "Sandalye Otur 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["so3"] = {"timetable@reunited@ig_10", "base_amanda", "Sandalye Otur 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["so4"] = {"timetable@ron@ig_3_couch", "base", "Sandalye Otur 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["so5"] = {"timetable@jimmy@mics3_ig_15@", "mics3_15_base_tracy", "Sandalye Otur 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["so6"] = {"timetable@maid@couch@", "base", "Sandalye Otur 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["soyan"] = {"timetable@ron@ron_ig_2_alt1", "ig_2_alt1_base", "Sandalye Otur (Yan)", AnimationOptions =
   {
       EmoteLoop = true,
   }},
