local Keys = {
		  ...
		  if PlayerData.job.grade <= 6 then
			  ...
			  if skin.sex == 0 then
				  ...
				  if Config.Uniforms[job].female ~= nil then
					  ...
					  ESX.ShowNotification(_U('cloakroom'))
				  end
  ...
  function OpenCloakroomMenu()
	...
	elseif grade == 'officer2' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'officer2_wear'})
	elseif grade == 'officer3' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'officer3_wear'})
	elseif grade == 'officer4' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'officer4_wear'})
	elseif grade == 'sergeant' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sergeant_wear'})
	elseif grade == 'sergeant2' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sergeant2_wear'})
	elseif grade == 'lieutenant1' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'lieutenant1_wear'})
	elseif grade == 'lieutenant2' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'lieutenant2_wear'})
	elseif grade == 'captain' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'captain_wear'})
	elseif grade == 'captain2' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'captain2_wear'})
	elseif grade == 'commander' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'commander_wear'})
	elseif grade == 'undersheriff' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'undersheriff_wear'})
	elseif grade == 'boss' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'boss_wear'})
	
	elseif grade == 'srecruit' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'srecruit_wear'})
	elseif grade == 'sofficer' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sofficer_wear'})
	elseif grade == 'ssergeant' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'ssergeant_wear'})
	elseif grade == 'sintendent' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sintendent_wear'})
	elseif grade == 'slieutenant' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'slieutenant_wear'})
	elseif grade == 'schef' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'schef_wear'})
	elseif grade == 'sboss' then
		table.insert(elements, {label = _U('sheriff_wear'), value = 'sboss_wear'})
	end

	if grade == 'cadet' or grade == 'officer' or grade == 'officer2' or grade == 'officer3' or grade == 'officer4'or grade == 'sergeant' or grade == 'sergeant2' or grade == 'lieutenant1' or grade == 'lieutenant2' or grade == 'captain' or grade == 'captain2' or grade == 'commander' or grade == 'undersheriff' or grade == 'boss' then
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'officer4_wear' or
			data.current.value == 'sergeant_wear' or
			data.current.value == 'sergeant_wear' or
			data.current.value == 'lieutenant1_wear' or
			data.current.value == 'lieutenant2_wear' or
			data.current.value == 'captain_wear' or
			data.current.value == 'captain2_wear' or
			data.current.value == 'commander_wear' or
			data.current.value == 'undersheriff_wear' or
				  ...
				  if closestPlayer ~= -1 and closestDistance <= 3.0 then
					  ...
					  if health == 0 then
						  ...
						  ClearPedTasks(playerPed)
							  ...
							  TriggerServerEvent('esx_ambulancejob:revive', GetPlayerServerId(closestPlayer))--('esx_sheriffjob:revive')
						  ...
						  ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							  if quantity > 0 then
								  ...
								  if health > 0 then
									  ...
									  Citizen.Wait(5000)
									  ClearPedTasks(playerPed)
										  TriggerServerEvent('esx_sheriffjob:heal', GetPlayerServerId(closestPlayer), 'small')
					  ...
					  elseif action == 'body_search' then
						  ...
						  TriggerEvent("m3:inventoryhud:client:openPlayerInventory", GetPlayerServerId(closestPlayer))
					  ...
					  elseif action == 'uncuff' then
						  --TriggerServerEvent('esx_sheriffjob:uncuff', GetPlayerServerId(closestPlayer))
  ...
  AddEventHandler('esx_sheriffjob:getuncuffed', function(playerheading, playercoords, playerlocation)
	  ...
	  Citizen.Wait(5500)
	  IsHandcuffed = false
	  TriggerEvent('esx_sheriffjob:uncuff')
	  ClearPedTasks(GetPlayerPed(-1))
  end)
  --------------------DEXA------------------
  ...
  Citizen.CreateThread(function()
	  while true do
			  if PlayerData.job == 'sheriff' and PlayerData.getInventoryItem('sheriffgps').count >= 1 then
				  TriggerEvent('esx_sheriffjob:updateBlip')
			  else
				  TriggerEvent('esx_sheriffjob:updateBlip')
			  end
  ...
  function createBlip(id)
	  ...
	  if not DoesBlipExist(blip) then -- Add blip and create head display on player
		  ...
		  AddTextComponentString('[~b~LSSD~s~]')
  ...
  AddEventHandler('esx_sheriffjob:updateBlip', function()
	  ...
	  if not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'sheriff' then
	  ...
	  if not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and PlayerData.job.name == 'sheriff' then
		  ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			  for i=1, #players, 1 do
  ...
  AddEventHandler('esx_sheriffjob:updateBlip', function()
	  ...
	  if PlayerData.job and PlayerData.job.name == 'sheriff' then
		  ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			  for i=1, #players, 1 do
				  if players[i].job.name == 'sheriff' and players[i].gps > 0 then
					  local id = GetPlayerFromServerId(players[i].source)
					  if NetworkIsPlayerActive(id) and GetPlayerPed(id) ~= PlayerPedId() then
						  createBlip(id)
					  end
  ...
  RegisterNetEvent('esx_sheriffjob:removeBlip')
  AddEventHandler('esx_sheriffjob:removeBlip', function()
  ...
  Citizen.CreateThread(function()
	  while true do
		  Citizen.Wait(15000)
		  if PlayerData.job and PlayerData.job.name == 'sheriff' then
			  ESX.TriggerServerCallback('esx_sheriffjob:getItemAmount', function(qtty)
				  if qtty > 0 then
					  TriggerEvent('esx_sheriffjob:updateBlip')
				  end
			  end, 'gps')
