...
--local blips = {
--  {name="Hospital", id=80, x= 259.8, y= -1359.16, z= 23.54, color= 1},
--}
...
function ConfigLang(lang)
  ...
  elseif lang == "EN" then
    lang_string = {
      text1 = "Tedavi olmak icin ~INPUT_VEH_HORN~ basın ~r~(~h~~g~5000$~r~)",
      text2 = "Doktor ~h~~g~seni ~s~tedavi ~h~~r~ediyor~s~ lütfen, ~h~~b~sabırlı ol~s~.",
      text3 = "Tedaviye ihtiyacin ~h~~r~yok~s~.",
      text4 = "Doktor ~h~~g~seni ~h~~r~tedavi~s~ etti.",
      text5 = "~h~Uzaklaştın ~h~~r~doktor~s~, seni ~h~~g~iyilestirmede~s~ basarısız ~h~~r~oldu~s~ !!!",
  }
  end
end
...
Citizen.CreateThread(function()
    ...
    while not HasModelLoaded(GetHashKey("s_m_m_doctor_01")) do
      ...
      local hospitalped =  CreatePed(4, 0xd47303ac, 259.8, -1359.16, 23.54, 49.404, false, true)
