...
RegisterServerEvent('esx_fbijob:requestarrest')
AddEventHandler('esx_fbijob:requestarrest', function(targetid, playerheading, playerCoords,  playerlocation)
    _source = source
    TriggerClientEvent('esx_fbijob:getarrested', targetid, playerheading, playerCoords, playerlocation)
    TriggerClientEvent('esx_fbijob:doarrested', _source)
end)

RegisterServerEvent('esx_fbijob:requestrelease')
AddEventHandler('esx_fbijob:requestrelease', function(targetid, playerheading, playerCoords,  playerlocation)
    _source = source
    TriggerClientEvent('esx_fbijob:getuncuffed', targetid, playerheading, playerCoords, playerlocation)
    TriggerClientEvent('esx_fbijob:douncuffing', _source)
end)
