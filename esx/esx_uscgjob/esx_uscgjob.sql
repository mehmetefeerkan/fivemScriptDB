...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('uscg',0,'recruit','USCG',300,'{}','{}'),
	('uscg',1,'officer','Polis Memuru',450,'{}','{}'),
	('uscg',2,'sergeant','Kidemli Polis',900,'{}','{}'),
	('uscg',3,'intendent','Komiser',1400,'{}','{}'),
	('uscg',4,'lieutenant','Baskomiser',2000,'{}','{}'),
	('uscg',5,'chef','Emniyet Amiri',2600,'{}','{}'),
	('uscg',6,'boss','Emniyet Muduru',4000,'{}','{}'),
	('uscg',7,'srecruit','Stajyer Şerif',300,'{}','{}'),
	('uscg',8,'sofficer','Şerif',400,'{}','{}'),
	('uscg',9,'ssergeant','Kidemli Şerif',850,'{}','{}'),
	('uscg',10,'sintendent','Komiser',1350,'{}','{}'),
	('uscg',11,'slieutenant','Baskomiser',1900,'{}','{}'),
	('uscg',12,'schef','Amir',2700,'{}','{}'),
	('uscg',13,'sboss','Serif',4000,'{}','{}')
;
