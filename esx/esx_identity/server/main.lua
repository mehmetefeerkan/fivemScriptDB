...
AddEventHandler('esx_identity:setIdentity', function(data, myIdentifiers)
	...
	print("^1Trigger:^1^3esx_identity:setIdentity^3 | ^7Kayıt Oldu.^2 ^3\nIdentity Bilgileri = { ^7\n" .. data.firstname .. "^7 " .. data.lastname .. "\n^2D.Tarihi:^2 ^3" .. data.dateofbirth .. "^7\n^7" .. xPlayer.identifier .. " ^3\nTarafindan tetiklendi.^3 }")
		if callback then
