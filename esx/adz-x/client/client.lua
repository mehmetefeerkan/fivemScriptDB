                        ...
                        if IsControlJustPressed(1, 38) then
                            ESX.TriggerServerCallback('ak4y_maddeX:bilgi', function(alindiMi, sure)
                                ...
                                if not alindiMi and not maddeAlinabilirMi and not kontrol then
                                    kontrol = true
                                    maddeXSure = sure
                                    if maddeXSure == 900000 then -- !!! Süreyi değiştirirseniz server tarafındakini de değiştirin yoksa script düzgün çalışmaz!!!
...
RegisterNetEvent("ak4y_maddeX:maddeIcme")
AddEventHandler("ak4y_maddeX:maddeIcme", function()
