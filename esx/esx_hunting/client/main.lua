...
local Positions = {
	...
	['Sell'] = { ['hint'] = '[E] Satış Yap', ['x'] = 969.16375732422, ['y'] = -2107.9033203125, ['z'] = 31.475671768188 },
							...
							if PlyToAnimal < 2.0 then
								...
								if IsControlJustReleased(0, Keys['E']) then
									if GetSelectedPedWeapon(PlayerPedId()) == GetHashKey('WEAPON_KNIFE')  then
										...
										ESX.ShowNotification('Bıçak kullanmalısın!')
									end
								end
...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('Hayvanı katlediniz ve  ' ..AnimalWeight.. 'kg etini aldınız')
