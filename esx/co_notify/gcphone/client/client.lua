...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    exports['co_notify']:SendNotify('mesaj', message.transmitter.." Tarafından gelen mesaj.", message.message)
    ESX.TriggerServerCallback('crew-phone:phone-check', function(durum)
      if durum ~= nil then
...
function sendMessage(number, message, _, coords) 
  TriggerServerEvent('esx_phone:send', number, message, _, coords)
end
...
if hasFocus == true then
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
    exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/818212227696820292/2UCznfjh2yP-Qb4BL5TFSYI-aiVyfQas-ieXr0Ec1hRgI3OUnkowFeK8A8OIbMme1-I0", data.field, function(data)
