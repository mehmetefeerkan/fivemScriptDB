...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x =-583.0945, y = -931.8593, z = 23.87109},
	...
	ls2 = {
		Pos   = { x =-583.2791, y = -924.6857, z = 23.87109},
		Size  = {x = 5.0, y = 5.0, z = 0.2},
		Color = {r = 0, g = 0, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x =-583.2923, y = -917.644, z = 23.87109},
		Size  = {x = 5.0, y = 5.0, z = 0.2},
		Color = {r = 0, g = 0, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls6 = {
		Pos   = { x =811.3054, y = -956.46, z = 26.76},
		Size  = {x = 5.0, y = 5.0, z = 0.2},
		Color = {r = 0, g = 0, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {9.50, 13.61, 20.31, 24.65}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {1.55, 4.2, 6.26, 12.62}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {8.93, 11.89, 14.32}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.62, 3.67, 11.2, 15.89, 26.64}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {15.45, 26.37, 31.93, 41.93, 59.3, 71.24}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
