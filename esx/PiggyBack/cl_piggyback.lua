...
AddEventHandler("moxha:sirtla", function()
	if not piggyBackInProgress then
		...
		if closestPlayer ~= -1 and closestPlayer ~= nil then
			...
			exports.pNotify:SendNotification({text = "Yakında Sırtına Alabilceğin Birisi YOK!", type = "error", timeout = math.random(1000, 6500)})
		end
	else
