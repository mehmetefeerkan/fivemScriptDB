...
Config.BankRobbery = {
    [1] = {
        ...
        Doors = { -- lägg ALLTID bankvalvs dörren sist (annars funkar inte hackningen)
            {Coords = vector3(257.22, 220.72, 106.28), Object = "hei_v_ilev_bk_gate_pris", Heading = -20.0, WeldPosition = {C = vector3(257.0, 219.76, 105.41), H = 338.38}, Time = 30, Frozen = true}, 
            {Coords = vector3(261.58, 222.05, 106.28), Object = "hei_v_ilev_bk_gate2_pris", Heading = -110.0, WeldPosition = {C = vector3(261.34, 221.91, 105.4), H = 254.73}, Time = 30, Frozen = true}, 
            {Coords = vector3(253.90, 225.23, 101.87), Object = "v_ilev_bk_vaultdoor", Heading = 160.0, OpenHeading = -20.0, Hacking = true, Time = 10, Frozen = true},
        },
        Safes = {
