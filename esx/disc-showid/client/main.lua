...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        --         AttachEntityToEntity(clipboardEntity, PlayerPedId(), GetPedBoneIndex(GetPlayerPed(PlayerId()), 18905), coords.x, coords.y, coords.z, rotation.x, rotation.y, rotation.z, 1, 1, 0, 1, 0, 1)
        --     else
        ...
        if shouldDraw or forceDraw then
            ...
            for k, v in pairs(nearbyPlayers) do
				...
				Draw3DText(x, y, z + 1.3, v.playerHex)
            end
        end
    end
end)
