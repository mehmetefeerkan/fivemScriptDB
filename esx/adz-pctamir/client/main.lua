...
Citizen.CreateThread(function()
    while true do
        ...
        if dstH <= 2.5 and IsControlJustReleased(0, 38) then
            ESX.TriggerServerCallback('adz-pctamir:getItemCount', function(cb)
                if cb >= araf.requiredItemCount then
                    ...
                    if araf.useSkillBar then
                        ...
                        if finished ~= 100 then
                            ...
                            TriggerServerEvent('adz-pctamir:deleteItem', araf.iron, 2)
                            ClearPedTasks(ply)
                        else
                            TriggerServerEvent('adz-pctamir:giveHeatedItem')
                            ClearPedTasks(ply)
                        end
                ...
                if cb >= araf.requiredItemCount then
                    ...
                    if araf.useSkillBar then
                        ...
                        if finished ~= 100 then
                            ...
                            TriggerServerEvent('adz-pctamir:deleteItem', araf.heatedIron, 2)
                            ClearPedTasks(ply)
                        else
                            TriggerServerEvent('adz-pctamir:giveWroughtedItem')
                            ClearPedTasks(ply)
                        end
                    elseif araf.useProgbar then
              ...
              --  pickaxe = CreateObject(GetHashKey("prop_tool_hammer"), 0, 0, 0, true, true, true) 
                ...
                if araf.useSkillBar then
                    ...
                    if finished ~= 100 then
                        ...
                        TriggerServerEvent('adz-pctamir:giveMiningItem')
                        ClearPedTasks(ply)
                        DetachEntity(pickaxe, 1, true)
                        DeleteEntity(pickaxe)
                        DeleteObject(pickaxe)
