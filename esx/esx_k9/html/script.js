...
var app = new Vue({
    ...
    data: {
        ...
        dog_models_list: [
			...
			{title: "Tekir", model: "a_c_cat_01", img: "images/kedi.png"}
        ],
        ...
        k9_name_rules: [
            ...
            v => v.length > 1 || 'Name must be atleast 1 character',
    ...
    methods: {
        ...
        SpawnPolisK9() {
            if (!this.dog_k9 == "") {
                axios.post("http://" + this.resource_name + "/spawnk9polis", {model: this.dog_k9}).then(function(response) {
                    console.log(response);
                }).catch(function(error) {
                    console.log(error);
                });
