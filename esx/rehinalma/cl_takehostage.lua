...
function takeHostage()
	...
	if not canTakeHostage then 
		-- exports['mythic_notify']:SendAlert('error', 'Birini rehin almak için tabancaya ihtiyacın var!')
	...
	if not holdingHostageInProgress and canTakeHostage then		
		...
		if closestPlayer ~= nil then
			...
			-- exports['mythic_notify']:SendAlert('error', 'Yakınında rehine alabileceğin kimse yok')
...
RegisterNetEvent('takehostage:true')
AddEventHandler('takehostage:true', function()
	while true do 
