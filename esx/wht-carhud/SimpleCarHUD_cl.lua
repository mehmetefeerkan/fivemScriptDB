-- Script Temeli : SimpleCarHud
-- Düzenleme : 'ra1der#0399
-- Herhangi bir sorunda discord üzerinden ulaşabilirsiniz.
...
local fuelWarnLimit = 20.0                  -- Fuel limit for triggering warning color
...
local seatbeltEjectSpeed = 65.13             -- Speed threshold to eject player (MPH)
local seatbeltEjectAccel = 60.0            -- Acceleration threshold to eject player (G's)
