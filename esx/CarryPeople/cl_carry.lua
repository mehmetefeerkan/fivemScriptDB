...
AddEventHandler("moxha:omuzla", function()
	if not carryingBackInProgress then
		...
		if closestPlayer ~= -1 and closestPlayer ~= nil then
			...
			exports.pNotify:SendNotification({text = "Yakında Omzuna Alabilceğin Birisi Yok!", type = "error", timeout = math.random(1000, 5000)})
		end
	else
